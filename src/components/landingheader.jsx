            ...
            <div className="header1 py-2 bg-dark text-white text-left row block fixed-top">
                ...
                <span className="col-2">
                    <div className="row px-5">
                        ...
                        <span className="col-4"><LinkedButton title="Support Ambify" color="btn-primary" url="https://www.buymeacoffee.com/srivatsavb" text={<i className="material-symbols-outlined">local_cafe</i>} /></span>
                    </div>
                </span>
            </div>
        );
