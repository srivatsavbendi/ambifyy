...
class Header extends Component {
    ...
    render() { 
        return (
            <div className="header1 py-2 bg-dark text-white text-left row block">
                ...
                <span className="col-2 ">
                    <div className="row px-5">
                        <span className="col-4"><LinkedButton url="https://www.buymeacoffee.com/" text={<i className="material-symbols-outlined">local_cafe</i>} /></span>
